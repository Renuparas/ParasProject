...
root.wm_title('Musically')

img = PhotoImage(file='D:\Python\music.gif')
next_ = PhotoImage(file = 'D:\Python/next.gif')
prev = PhotoImage(file='D:\Python\previous.gif')
play = PhotoImage(file='D:\Python\play.gif')
pause = PhotoImage(file='D:\Python\pause.gif')
